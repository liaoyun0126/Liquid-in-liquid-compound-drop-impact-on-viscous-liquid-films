...
folder = 'VideoBas1'  # output folder
if not os.path.isdir(folder):
    os.makedirs(folder)

rmin, rmax, zmin, zmax = [-2.5, 2.5, -hf, 4.0-hf]
    ...
    if not os.path.exists(place):
        ...
        if os.path.exists(name):
            ...
            if (len(facets1)):
                ...
                color1=np.array([117,112,179])/255.
                color2=np.array([217,95,2])/255.

                ## omega
                cntrl1 = ax.imshow(D2, interpolation='bilinear', cmap="gray_r", origin='lower', extent=[0, -rmax, zmin, zmax], vmax = 2, vmin = -2)
                ...
                line_segments3 = LineCollection(facets3, linewidths=4, colors='blue', linestyle='solid')
